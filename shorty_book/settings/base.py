...
SECRET_KEY = "kmgunhoc7h10_aq$bc@c9g_ynm@kw@)2k(#e(e4e2_4ntwrr5-"
...
ROOT_URLCONF = 'shorty_book.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'shorty_book.wsgi.application'
...
DEFAULT_FROM_EMAIL = "hello@shorty_book.com"
SERVER_EMAIL = "error@shorty_book.com"
from shorty_book.settings.app import *
...
GRAPPELLI_ADMIN_TITLE = 'shorty_book'
